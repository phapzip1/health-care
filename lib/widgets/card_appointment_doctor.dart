            ...
            widget.changedPage
                ...
                : SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF2F80ED), elevation: 0, padding: const EdgeInsets.symmetric(vertical: 8)),
                      onPressed: () {
                        NavigationService.navKey.currentState?.pushNamed('/writerecord', arguments: widget.schedule);
                      },
                      child: const Text(
                        'Write record',
                        style: TextStyle(
